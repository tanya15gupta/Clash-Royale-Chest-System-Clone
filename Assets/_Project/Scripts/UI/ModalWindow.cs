...
namespace ChestSystem
{
    public class ModalWindow : MonoBehaviour
    {
        ...
        [SerializeField] private GameObject m_acceptButton;
        [SerializeField] private GameObject m_declineButton;
		...
		{	
			...
			m_acceptButton.SetActive(_isAcceptButtonActive);
			m_declineButton.SetActive(_isActive);
			onAccept = _onConfirm;
		}
